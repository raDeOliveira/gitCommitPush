...
namespace GitCommitPush
{
    public partial class Init : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string gitRemote = @"git remote add origin " + remoteUri_txt.Text + ""; // & sleep 2 & git commit -m '" + commit_txt.Text + "' & sleep 2 & git push -u origin master";
            ...
            ProcessStartInfo processStartInfo = new ProcessStartInfo(fileName, "-c \" " + gitRemote + " & \"" + gitCommit + " & \"" + gitPush + " & \"")
            {
