...
namespace GitCommitPush
{
    public partial class Init : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string command = @"git init & sleep 0.5 & git add . & git remote add origin " +
                remoteUri_txt.Text + " & git commit -m '" +
                commit_txt.Text + "' & sleep 0.9 & git push -u origin master";

            string workingDir = @"" + path_text.Text + "";
            menu.getPath = path_text.Text;
